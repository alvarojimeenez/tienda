...
<body>
	...
	String mensaje = request.getParameter("delete")==null?"Borrar":cadena;
	try{
		...
		if(request.getParameter("delete")!=null){
			try{
				if (request.getParameter("delete").equals("Borrar")){
				...
				}else if(request.getParameter("delete").equals(cadena)) {
					String nombreCliente = request.getParameter("nombreCliente");
					String apellidoCliente = request.getParameter("apellidoCliente");
					String emailCliente = request.getParameter("emailCliente");
					cliente = new Cliente(Integer.valueOf(idCliente), nombreCliente, apellidoCliente, emailCliente);
					DbRepository.delete(cliente);
	...
	<form>
			...
			<button type="submit" class="btn btn-primary" name="delete" value="<%= mensaje %>"><%= mensaje %></button>
		</form>
